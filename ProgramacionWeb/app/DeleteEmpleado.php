...
<link rel="stylesheet" href="../public/css/style-form.css" type="text/css" media="all" />
</head>
<body> <?php
		...
		$sql = "SELECT TipoDocumento,Documento,PrimerNombre,SegundoNombre,PrimerApellido,SegundoApellido,DirResidencia,Municipio,Departamento,
						 ...
						 Sexo,Ndocumento,TipDocumento,FechaExpe FROM afiliado WHERE Documento='$_REQUEST[documento]'";
