...
<body onLoad="activarPrimerControl()">
	...
	$bene0  = "SELECT * from beneficiario   where Documento=?";
	$sql 	= "SELECT * from afiliado   where Documento=?";
	$bene1  = "SELECT * from beneficiario   where Documento=?";
	...
	?>
		<form action="AccionUpConsulta2.php" method="post">
			<tr>
				<td>
					<table border="3" bgcolor="#aed2f4">
						<tr>
							<td style="color:#ffffff" bgcolor="#797575">
								<strong><em>Actualizar Datos Basicos Afiliado</em></strong>
							</td>
						</tr>
						<tr>
							<td> TipoDocumento: <input type="radio" name="tipo" value="RC">RC
			...
			<tr>
				<td> Municipio: <SELECT name="mu">
						<option value="Cali">Cali</option>
						<option value="Palmira">Palmira</option>
						<option value="Jamundi">Jamundi</option>
					</SELECT>
				</td>
				<td> Departamento: <SELECT name="dep">
			...
			<tr>
				<td> MunNacimiento: <SELECT name="mun">
						<option value="Cali">Cali</option>
						<option value="Palmira">Palmira</option>
						<option value="Jamundi">Jamundi</option>
					</SELECT>
				</td>
				<td> DepNacimiento: <SELECT name="depn">
						<option value="Valle">Valle</option>
						<option value="Cauca">Cauca</option>
						<option value="Narino">Narino</option>
					</SELECT>
				</td>
				<td> FechaN: <input type="date" name="fechan" value="<?php echo $regempleado['FechaN'] ?>">
				</td>
			</tr>
			<tr>
			...
			<table border="3" bgcolor="#aed2f4">
				...
				<tr>
				<tr>
					<td> TipoDocumento: <input type="radio" name="tipo0" value="RC">RC
				...
				<tr>
					...
					<td>Novedad: <input type="radio" name="nov0" value="Ingreso">
				...
				<tr>
					<td>DirResidencia: <input type="text" name="dire0" value="<?php echo $regem['DirResidencia'] ?>">
					</td>
					<td>Municipio: <SELECT name="mu0">
							<option value="Cali">Cali</option>
							<option value="Palmira">Palmira</option>
							<option value="Jamundi">Jamundi</option>
						</SELECT>
					</td>
					<td>Departamento: <SELECT name="dep0">
							<option value="Valle">Valle</option>
							<option value="Cauca">Cauca</option>
							<option value="Narino">Narino</option>
						</SELECT>
				...
				<tr>
					<td>FechaN: <input type="date" name="fechan0" value="<?php echo $regem['FechaN'] ?>">
					</td>
