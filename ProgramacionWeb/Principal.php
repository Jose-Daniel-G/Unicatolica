...
<body>
	...
	<div class="header">
		...
		<br><br><br><br>
		<audio id="player" src="TheFatRat.mp3"></audio>
<div>
	...
	<div class="about" id="about"><div class="container">
        <div class="about-info">
				<div class="col-md-6 about-info-grid">
					<div class="about-info-list1">
						<h5>Consultas</h5>
						<ul>
							<li><a href="Parcialcorte/pagina3F.php"><span class="glyphicon glyphicon-arrow-right" aria-hidden="true"></span> CREAR UN AFILIADO</a></li>
							<li><a href="Parcialcorte/eliminarEmpleado.php"><span class="glyphicon glyphicon-arrow-right" aria-hidden="true"></span> ELIMINAR UN AFILIADO</a></li>
							<li><a href="Parcialcorte/consultarEmpleado.php"><span class="glyphicon glyphicon-arrow-right" aria-hidden="true"></span> CONSULTA GENERAL DE AFILIADOS</a></li>
							<li><a href="Parcialcorte/Documento.php"><span class="glyphicon glyphicon-arrow-right" aria-hidden="true"></span> CONSULTA EMPLEADO POR DOCUMENTO</a></li>
							 <li><a href="Parcialcorte/codigoLiquidar.php"><span class="glyphicon glyphicon-arrow-right" aria-hidden="true"></span> LIQUIDAR EMPLEADO POR DOCUMENTO</a></li>
							 <li><a href="Parcialcorte/UpConsulta.php"><span class="glyphicon glyphicon-arrow-right" aria-hidden="true"></span>ACTUALIZAR AFILIADO POR DOCUMENTO</a></li>
							
						
						</ul>
					</div>
					<div class="about-info-image">
						<img src="images/afiliado.png" alt="Corsa Racer">
					</div>
		...
		<div class="container">
			...
			<div class="feature-grid">
				<div class="col-md-4 col-sm-4 feature1">
					<div class="row features-item sans-shadow text-center">
						<div class="features-icon">
							<img src="images/ProgramaA.png" alt="Corsa Racer">
						</div>
				...
				<div class="col-md-4 col-sm-4 feature1">
					<div class="row features-item sans-shadow text-center">
						<div class="features-icon">
							<img src="images/articulo.jpg" alt="Corsa Racer">
						</div>
						<div class="features-info">
				...
				<div class="col-md-4 col-sm-4 feature1">
					<div class="row features-item sans-shadow text-center">
						<div class="features-icon">
							<img src="images/dbua.png" alt="Corsa Racer">
						</div>
						<div class="features-info">
							<h4>Descuentos </h4>
				...
				<div class="col-md-4 col-sm-4 feature1">
					<div class="row features-item sans-shadow text-center">
						<div class="features-icon">
							<img src="images/normas.png" alt="Corsa Racer">
						</div> 
						<div class="features-info">
							<h4>Normas</h4>
						</div>
		...
		<div class="container">
			<div class="grid">
				<figure class="effect-dexter">
					<img src="images/team-0.jpg" alt="Corsa Racer"/>
					<figcaption>
				...
				<figure class="effect-dexter">
					<img src="images/JUAN.jpg" alt="Corsa Racer"/>
					<figcaption>
