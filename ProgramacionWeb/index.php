...
<head>
	...
	<!-- Bootstrap-Core-CSS --><link rel="stylesheet" href="public/css/bootstrap.min.css" type="text/css" media="all" />
	<!-- Index-Page-Styling --><link rel="stylesheet" href="public/css/style.css" type="text/css" media="all" />
	<!-- Owl-Carousel-CSS -->  <link rel="stylesheet" href="public/css/owl.carousel.css" type="text/css" media="all" />
	<!-- Popup-Box-CSS -->     <link rel="stylesheet" href="public/css/popuo-box.css" type="text/css" media="all" />
	<!-- //Custom-Stylesheet-Links -->
...
<body>
	...
	<div class="header">
		...
		<br><br><br><br>
		<audio id="player" src="public/TheFatRat.mp3"></audio>
		<div>
	...
	<div class="caption-popup">
		<div id="small-dialog" class="mfp-hide innercontent">
			...
			<img class="img-responsive" src="public/images/1.jpg" title="postname" />
			...
			<div class="about-info">
				<div class="col-md-6 about-info-grid">
					<div class="about-info-list1">
						<h5>Consultas</h5>
						<ul>
							<li><a href="app/pagina3F.php"><span class="glyphicon glyphicon-arrow-right" aria-hidden="true"></span> CREAR UN AFILIADO</a></li>
							<li><a href="app/eliminarEmpleado.php"><span class="glyphicon glyphicon-arrow-right" aria-hidden="true"></span> ELIMINAR UN AFILIADO</a></li>
							<li><a href="app/consultarEmpleado.php"><span class="glyphicon glyphicon-arrow-right" aria-hidden="true"></span> CONSULTA GENERAL DE AFILIADOS</a></li>
							<li><a href="app/Documento.php"><span class="glyphicon glyphicon-arrow-right" aria-hidden="true"></span> CONSULTA EMPLEADO POR DOCUMENTO</a></li>
							<li><a href="app/codigoLiquidar.php"><span class="glyphicon glyphicon-arrow-right" aria-hidden="true"></span> LIQUIDAR EMPLEADO POR DOCUMENTO</a></li>
							<li><a href="app/UpConsulta.php"><span class="glyphicon glyphicon-arrow-right" aria-hidden="true"></span>ACTUALIZAR AFILIADO POR DOCUMENTO</a></li>


						</ul>
					</div>
					<div class="about-info-image">
						<img src="public/images/afiliado.png" alt="Corsa Racer">
					</div>
		...
		<div class="container">
			...
			<div class="feature-grid">
				<div class="col-md-4 col-sm-4 feature1">
					<div class="row features-item sans-shadow text-center">
						<div class="features-icon">
							<img src="public/images/ProgramaA.png" alt="Corsa Racer">
						</div>
				...
				<div class="col-md-4 col-sm-4 feature1">
					<div class="row features-item sans-shadow text-center">
						<div class="features-icon">
							<img src="public/images/articulo.jpg" alt="Corsa Racer">
						</div>
						<div class="features-info">
				...
				<div class="col-md-4 col-sm-4 feature1">
					<div class="row features-item sans-shadow text-center">
						<div class="features-icon">
							<img src="public/images/dbua.png" alt="Corsa Racer">
						</div>
						<div class="features-info">
							<h4>Descuentos </h4>
				...
				<div class="col-md-4 col-sm-4 feature1">
					<div class="row features-item sans-shadow text-center">
						<div class="features-icon">
							<img src="public/images/normas.png" alt="Corsa Racer">
						</div>
						<div class="features-info">
							<h4>Normas</h4>
						</div>
				...
				<div class="col-md-4 col-sm-4 feature1">
					<div class="row features-item sans-shadow text-center">
						<div class="features-icon">
							<img src="public/images/world.png" alt="Corsa Racer">
						</div>
						<div class="features-info">
							<h4>Internacional</h4>
						</div>
				...
				<div class="col-md-4 col-sm-4 feature1">
					<div class="row features-item sans-shadow text-center">
						<div class="features-icon">
							<img src="public/images/multiplayer.png" alt="Corsa Racer">
						</div>
						<div class="features-info">
			...
			<div class="container">
				<div class="grid">
					<figure class="effect-dexter">
						<img src="public/images/team-0.jpg" alt="Corsa Racer" />
						<figcaption>
					...
					<figure class="effect-dexter">
						<img src="public/images/JUAN.jpg" alt="Corsa Racer" />
						<figcaption>
