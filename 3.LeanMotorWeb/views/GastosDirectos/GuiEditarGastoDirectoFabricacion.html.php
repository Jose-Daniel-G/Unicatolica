...
<div class="card">
    ...
    <div class="card-header">
        <h4>
            <b>Gasto Directo de Fabricación - Editando</b>
        </h4>
    </div>
        ...
        <input type="hidden" id="tipo_doc" name="tipo_doc" value="GD">
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-6">
                        <div class="pb-3 align-items-center row">
                            <div class="p-0 col-9">
                                ...
                                <button type="submit" class="btn btn-primary" name="RegGD" id="RegGD" value="Guardar" title="Actualizar Gasto Directo"><li class="fa fa-save"></li></button>
                                ...
                                <button type="button" class="btn text-white" style="background-color: Red;" name="AnularGastoDirecto" title="Anular Gasto Directo"  data-url='<?=getUrl("GastosDirectos", "GastosDirectos", "AnularGastoDirecto", false, "ajax")  ?>' id="AnularGastoDirecto" value="Anular"><i class="fa fa-trash-alt"></i></button>
                            </div>
                            <div class="col-3">
                ...
                <div class="pt-3 pb-3 row">
                    ...
                    <div class="p-0 col-2">
						<div class="row">
							...
							<div class="col-9">
								<input type="text" name="Fecha_Doc" id="Fecha_Doc" class="form-control datepicker" value="<?=substr($gasto["Fecha_Documento"],0,10); ?>" readonly>
							</div>
						</div>
					</div>
				...
				<div class="pt-3 pb-3 row">
					<div class="col-4">
						<div class="row">
							...
							<div class="p-0 col-4">
								<input type="text" name="Fecha_Gasto" id="Fecha_Gasto" class="form-control datepicker" value="<?=substr($gasto["Fecha_Gasto"], 0, 10); ?>" readonly>
							</div>
						</div>
					</div>
					...
					<div class="col-3">
						<div class="row">
							...
							<div class="col-8">
								<input type="text" name="Total" id="Total" class="form-control format" value="<?=$gasto["Total"]; ?>">
							</div>
						</div>
					</div>
				...
				<div class="pt-3 pb-3 row">
					<div class="col-4">
						<div class="row">
							...
							<div class="col-6">
								<input type="text" name="NoDocumentoCruce" id="NoDocumentoCruce" class="form-control" value="<?=$gasto["NoDocumentoCruce"]; ?>">
							</div>
						</div>
					</div>
						...
						<div class="row">
							...
							<div class="col-6">
								<select name="TipoDocumentoCruce" id="TipoDocumentoCruce" class="form-control select2">
                                    <?php
                                        $option = array(
                                            "Seleccione ...", "Factura", "Remision", "Cuenta de Cobro"
                                        );
                                        $valor = array(
                                            "", "FV", "RM", "CC"
                                        );
				...
				<div class="pt-3 pb-3 row">
					...
					<div class="col-11">
						<textarea name="Detalle" id="Detalle" rows="5" class="form-control"><?=$gasto["Detalle"]; ?></textarea>
					</div>
				</div>
            </div>
