					...
					<div class="table-responsive" id="scrollmarca" style='height:400px'>
						<table   class="table table- table-hover" >									
							<thead>
								...
								<tr>
									<td colspan='3'><input type="text" name="descripcion" id="descripcion" class="form-control busVivienda" placeholder='Descripcion' data-url="<?php echo getUrl("Viviendas", "Viviendas", "listarViviendas",false,"ajax") ?>"></td>								
								</tr>
								<tr>
							...
							<tbody id="respuestaViviendas" data-url="<?php echo getUrl ('Viviendas','Viviendas','getllenarViviendas',false,'ajax')?>">
							</tbody>
						</table>         
					</div>
				</form>
