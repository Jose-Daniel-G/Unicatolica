...
<div class="card">
    ...
    <div class="card-header">
        <h4>
            <b>Remisiones - Editando</b>
        </h4>
    </div>

    <div class="card-body">
        <form method="post" id="formEditRemision" autocomplete="off" action="<?=getUrl("Remisiones", "Remisiones", "EditarRemision", false, "ajax");  ?>">
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-6">
                        <div class="pb-3 row">
                            <div class="col-9">
                                ...
                                <button type="submit" class="btn btn-primary" name="ActuRM" id="ActuRM" value="Guardar" title="Actualizar Remisión"><li class="fa fa-save"></li></button>
                                ...
                                <button type="button" class="btn text-white" style="background-color: Red;" name="AnularRM" title="Anular Remisión"  data-url='<?=getUrl("Remisiones", "Remisiones", "AnularRemision", false, "ajax")  ?>' id="AnularRM" value="Anular"><i class="fa fa-trash-alt"></i></button>
                            </div>
                            <div class="col-2">
									...
									<div class="col-6">
										<div class="row">
											<div class="col-4">
												...
												<input class="form-control" name="TipoTrabajo" id="Garantia" type="radio" style="width: 20px; margin: -5px 20px;" value="G" checked>
                                                <?php else: ?>
                                                <input class="form-control" name="TipoTrabajo" id="Garantia" type="radio" style="width: 20px; margin: -5px 20px;" value="G">
                                                <?php endif; ?>
											</div>
											<div class="col-7">
									...
									<div class="col-6">
										<div class="row">
											<div class="col-4">
												...
												<input class="form-control" name="TipoTrabajo" id="Devanado" type="radio" style="width: 20px; margin: -5px 20px;" value="D" checked>
                                                <?php else: ?>
                                                <input class="form-control" name="TipoTrabajo" id="Devanado" type="radio" style="width: 20px; margin: -5px 20px;" value="D">
                                                <?php endif; ?>
											</div>
											<div class="col-7">
									...
									<div class="col-6">
										<div class="row">
											<div class="col-4">
												...
												<input class="form-control" name="TipoTrabajo" id="Obsequio" type="radio" style="width: 20px; margin: -5px 20px;" value="O" checked>
                                                <?php else: ?>
                                                <input class="form-control" name="TipoTrabajo" id="Obsequio" type="radio" style="width: 20px; margin: -5px 20px;" value="O">
                                                <?php endif; ?>
											</div>
											<div class="col-7">
									...
									<div class="col-6">
										<div class="row">
											<div class="col-4">
												...
												<input class="form-control" name="TipoTrabajo" id="Facturado" type="radio" style="width: 20px; margin: -5px 20px;" value="F" checked>
                                                <?php else: ?>
                                                <input class="form-control" name="TipoTrabajo" id="Facturado" type="radio" style="width: 20px; margin: -5px 20px;" value="F">
                                                <?php endif; ?>
											</div>
											<div class="col-7">
									...
									<div class="col-6">
										<div class="row">
											<div class="col-4">
												...
												<input class="form-control" name="TipoTrabajo" id="VentaProducto" type="radio" style="width: 20px; margin: -5px 20px;" value="V" checked>
                                                <?php else: ?>
                                                <input class="form-control" name="TipoTrabajo" id="VentaProducto" type="radio" style="width: 20px; margin: -5px 20px;" value="V">
                                                <?php endif; ?>
											</div>
											<div class="col-7">
									...
									<div class="col-6">
										<div class="row">
											<div class="col-4">
												...
												<input class="form-control" name="TipoTrabajo" id="Outsourcing" type="radio" style="width: 20px; margin: -5px 20px;" value="U" checked>
                                                <?php else: ?>
                                                <input class="form-control" name="TipoTrabajo" id="Outsourcing" type="radio" style="width: 20px; margin: -5px 20px;" value="U">
                                                <?php endif; ?>
											</div>
											<div class="col-7">
                    ...
                    <div class="pt-2 pb-2 fila_Detalle_General row">
                        ...
                        <div class="col-10">
                            <div class="row">
                                    ...
                                    <input type="hidden" id="item1" name="item_Editar[]" class="itemDetalle" value="1">
                                <div class="col-5">
                                ...
                                <div class="col-7">
                                    <input type="text" name="detalle_Editar[]" id="detalle<?=$i;?>" class="form-control" value="<?=$detalle["Detalle"]; ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-1">
                            <div class="row">
                                <div class="p-0 col-11">
                                    <input type="number" name="cant_Editar[]" id="cant<?=$i;?>" class="form-control text-center cantDetalle" value="<?=$detalle["Cantidad"]; ?>">
                                </div>
                            </div>
                        </div>

                        <div class="col-1 align-self-center">
                            <button type="button" class="btn btn-danger fa fa-minus btn_eliminarFilaDetalle_General" title="Eliminar fila" data-url="<?=getUrl("Utilidades", "Utilidades", "EliminarDetalleDoc", false, "ajax");  ?>"></button>
                        </div>
                    </div>
                    <?php $i++; ?>
                    <?php endforeach; ?>
				...
				<div id="Basica" style="display: none;">
					<div class="pt-3 pb-3 row">
						...
						<div class="col-10">
							<textarea name="Observaciones" id="Observaciones" class="form-control" rows="4"><?=$cabecera["Observaciones"]; ?></textarea>
						</div>
					</div>
				</div>
                            ...
                            <div class="col-6">
                                <div class="pt-3 pb-3 border row">
                                    ...
                                    <div class="col-6" style="padding: 0px 8px 0px 0px !important;">
                                        <input type="text" name="Fecha_Entrega" id="fecha_EntregaRM" class="form-control datepicker" placeholder="aaaa-mm-dd" 
				...
				<div class="align-items-center row">
                    <div class="col-12">
                        <div class="row" id="observacionesDetalle" style="display: none;">
                            ...
                            <div class="col-10">
                                <textarea name="Observaciones" id="observa" class="form-control" rows="4"><?=$cabecera["Observaciones"]; ?></textarea>
                            </div>
                        </div>
                    </div>
				</div>
