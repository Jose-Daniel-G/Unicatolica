...
<div class="card">
    ...
    <div class="card-header">
        <h4>
            <b>Orden de Trabajo FM-03 - Editando</b>
        </h4>
    </div>

    <div class="card-body">
        <form method="post" id="formEditOrdenTrabajo" autocomplete="off" action="<?=getUrl("OrdenTrabajo", "OrdenTrabajo", "EditarOrdenTrabajo", false, "ajax");  ?>">
                    ...
                    <div class="col-7">
                        <div class="pb-3 align-items-center row">
                            <div class="p-0 col-10">
                                ...
                                <button type="submit" class="btn btn-primary" name="RegGER" id="RegGER" value="Guardar" title="Actualizar Orden de Trabajo"><li class="fa fa-save"></li></button>
                                ...
                                <button type="button" class="btn text-white" style="background-color: LightSkyBlue;" title="Nuevo Reproceso"  id="reprocesoOrdenTrabajo" data-url="<?=getUrl("OrdenTrabajo", "OrdenTrabajo", "validarReprocesoOrden", false, "ajax"); ?>"><i class="fa fa-undo"></i></button>
                                
                                <button type="button" class="btn text-white" style="background-color: MediumOrchid;" title="Actualizar Orden Ejecución"  id="actualizarOrdenTrabajo"><i class="fa fa-file-import"></i></button>
                                ...
                                <button type="button" class="btn text-white" style="background-color: Red;" name="AnularOrdenTrabajo" title="Anular Orden de Trabajo"  data-url='<?=getUrl("OrdenTrabajo", "OrdenTrabajo", "AnularOrdenTrabajo", false, "ajax")  ?>' id="AnularOrdenTrabajo" value="Anular"><i class="fa fa-trash-alt"></i></button>
                            </div>
                            <div class="col-2">
                ...
                <div class="pt-3 pb-3 row">
                    ...
                    <div class="col-2">
						<div class="pt-2 pb-2 row">
							<div class="p-0 col-2">
                                ...
                                <input class="form-control" name="Garantia" id="Garantia" type="checkbox" style="width: 20px; margin: -5px 20px;" checked>
								<?php else: ?>
                    ...
                    <div class="p-0 col-2">
						<div class="row">
							...
							<div class="col-9">
								<input type="text" name="Fecha_Doc" id="Fecha_Doc" class="form-control datepicker" value="<?=$orden["Fecha_Creada"]; ?>" readonly>
							</div>
						</div>
					</div>
                    ...
                    <div class="col-5">
                        <div class="pt-3 pb-3 row">
                            ...
                            <div class="col-10">
                                ...
                                <input type="hidden" name="nit_empresa" value="<?=$ingreso["Nit_Cliente"]; ?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-3">
                        <div class="pt-3 pb-3 row">
                            ...
                            <div class="p-0 col-9">
                                ...
                                <input type="hidden" name="planta" value="<?=$ingreso["Codigo_Planta"]; ?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="pt-2 pb-2 fila_Detalle_General row">
                        ...
                        <div class="col-10">
                            <div class="row">
                                ...
                                <div class="col-5">
                                    <select name="producto_Editar[]" id="producto<?=$i;?>" class="form-control select2 productos_servicios" required>
                                        <option value="">Seleccione ...</option>
                                        <?php foreach ($servicios as $servicio): ?>
                                ...
                                <div class="col-7">
                                    <input type="text" name="detalle_Editar[]" id="detalle<?=$i;?>" class="form-control" value="<?=$detalle["Detalle_Actividad"]; ?>" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-1">
                            <div class="row">
                                <div class="p-0 col-11">
                                    <input type="tex" name="cant_Editar[]" id="cant<?=$i;?>" class="form-control text-center number cantDetalle" value="<?=$detalle["Cantidad"]; ?>" required>
                                </div>
                            </div>
                        </div>
