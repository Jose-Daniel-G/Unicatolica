...
if ($tipo_doc == "CT") {
    ...
    $codigoHTML.='<table class="table-borderless" width="100%;">
        ...
        <tr>
            <th class="text-center pb-4" colspan="3">Características del Equipo</t>
        </tr>
    ...
    $codigoHTML.='<table class="table-borderless" width="100%;">
    <tr>
        <th class="pb-4 pt-4 text-center" colspan="5">Actividades a Realizar</th>
    </tr>
    ...
    <tr>
        ...
        <td class="text-right font-weight-bold">Valor</td>
    ...
    $codigoHTML.='<table class="pt-4 table-borderless" width="100%;">
            <tr>
                ...
                <td>&nbsp;</td>
                <td>Subtotal: </td><td class="font-weight-bold text-right">'.number_format($cabecera["Subtotal"]).'</td>
            </tr>

            <tr>
                <td>Forma de Pago: <span class="font-weight-bold">'.$cabecera["Forma_Pago"].'</span></td>
                <td>&nbsp;</td>
                <td>Descuento: </td><td class="font-weight-bold text-right">'.number_format($cabecera["Descuento"]).'</td>
            </tr>

            <tr>
                <td>Tiempo de Entrega: <span class="font-weight-bold">'.$cabecera["Prioridad"].' Días</span></td>
                <td>&nbsp;</td>
                <td>Iva: </td><td class="font-weight-bold text-right">'.number_format($cabecera["Iva"]).'</td>
            </tr>

            <tr>
                <td>Observaciones: <span class="font-weight-bold">'.$cabecera["Observaciones"].'</span></td>
                <td>&nbsp;</td>
                <td>Total Cotizacion: </td><td class="font-weight-bold text-right">'.number_format($cabecera["Total"]).'</td>
            </tr>
