...
<div class="card">
    ...
    <div class="card-header">
        <h4>
            <b>Informe Técnico Reparación y Pruebas - Editando</b>
        </h4>
    </div>
                    ...
                    <div class="col-6">
                        <div class="row">
                            <div class="col-9">
                                ...
                                <button type="submit" class="btn btn-primary" name="ActuInformeTecnico" id="ActuInformeTecnico" value="Guardar" title="Actualizar Informe Técnico"><li class="fa fa-save"></li></button>
                                ...
                                <button type="button" class="btn text-white" style="background-color: Red;" name="AnularInformeTecnico" title="Anular Informe Técnico"  data-url='<?=getUrl("Informes", "Informes", "AnularInformeTecnico", false, "ajax")  ?>' id="AnularInformeTecnico" value="Anular"><i class="fa fa-trash-alt"></i></button>
                            </div>
                            <div class="col-3">
                ...
                <?php if ($usua_perfil == 1): ?>
                    ...
                    <div class="col-3">
						<div class="row">
							...
							<div class="col-7">
								<input type="text" name="Fecha_Doc" id="Fecha_Doc" class="form-control datepicker" value="<?=$informe["Fecha_Documento"]; ?>" readonly>
							</div>
						</div>
					</div>
                ...
                <div class="pt-3 datoscliente row">
                    ...
                    <div class="col-3">
                        <div class="pt-3 pb-3 row">
                            ...
                            <div class="col-8">
                                <input type="text" name="num_ingreso" id="num_ingreso" class="form-control" type-of-view="editar" data-urlDetalle="<?=getUrl("Informes", "Informes", "cargarDetalleRevisionIngreso", false, "ajax"); ?>" value="<?=$ingreso["Numero_Ingreso"]; ?>" readonly>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="modal-content">
                            <div class="modal-body">
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-12">
                                            <textarea name="Observaciones_Causa_Falla" id="Observaciones_Causa_Falla" rows="5" class="form-control"><?=$informe["Observaciones_Causa_Falla"]; ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="container-fluid">
                    <table id="tablaRevisionIngreso" class="table-bordered table-hover" width="100%;">
                        ...
                        <thead class="table text-white bg-primary thead-primary">
                            <tr>
                                <th class="d-none">Numero_Registro</th>
                                <th class="d-none">Codigo_Revision</th>
                        ...
                        <div class="modal-content">
                            <div class="modal-body">
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-12">
                                            <textarea name="Observaciones_Inspeccion" id="Observaciones_Inspeccion" rows="5" class="form-control"><?=$informe["Observaciones_Inspeccion"]; ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="pt-2 row">
                                        <div class="col-6">
                                            <div class="row">
                                                ...
                                                <div class="p-0 col-5">
                                                    <input type="text" name="Volt_Prueba" id="Volt_Prueba" class="form-control number" value="<?=$informe["Volt_Prueba"]; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-6">
                                            <div class="row">
                                                ...
                                                <div class="p-0 col-5">
                                                    <input type="text" name="Hipot_mA" id="Hipot_mA" class="form-control" value="<?=$informe["Hipot_mA"]; ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            <div class="row">
                                                ...
                                                <div class="p-0 col-7">
                                                    <input type="text" name="Surge_Impulso_F1" id="Surge_Impulso_F1" class="form-control" value="<?=$informe["Surge_Impulso_F1"]; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-4">
                                            <div class="row">
                                                ...
                                                <div class="p-0 col-7">
                                                    <input type="text" name="Surge_Impulso_F2" id="Surge_Impulso_F2" class="form-control" value="<?=$informe["Surge_Impulso_F2"]; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-4">
                                            <div class="row">
                                                ...
                                                <div class="p-0 col-7">
                                                    <input type="text" name="Surge_Impulso_F3" id="Surge_Impulso_F3" class="form-control" value="<?=$informe["Surge_Impulso_F3"]; ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-8">
                                            <div class="row">
                                                ...
                                                <div class="pr-2 pl-0 col-4">
                                                    <input type="text" name="Volt_Prueba2" id="Volt_Prueba2" class="form-control number" value="<?=$informe["Volt_Prueba2"]; ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="pt-2 row">
                                        <div class="col-12">
                                            <div class="align-items-center row">
                                                ...
                                                <div class="col-7">
                                                    <input type="text" name="R_Aisl_Gohm" id="R_Aisl_Gohm" class="form-control" value="<?=$informe["R_Aisl_Gohm"]; ?>">
                                                </div>
                                                <div class="p-0 col-2">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-body">
                                                    <div class="container-fluid">
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <textarea name="Observaciones_Pru_elec" id="Observaciones_Pru_elec" rows="5" class="form-control"><?=$informe["Observaciones_Pru_elec"]; ?></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-12">
                                            <div class="align-items-center row">
                                                ...
                                                <div class="pr-2 pl-0 col-4 text-center">
                                                    <input type="text" name="Axial_Lc" id="Axial_Lc" class="form-control" value="<?=$informe["Axial_Lc"]; ?>">
                                                </div>
                                                <div class="pr-2 pl-0 col-4 text-center">
                                                    <input type="text" name="Axial_Loc" id="Axial_Loc" class="form-control" value="<?=$informe["Axial_Loc"]; ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="align-items-center pt-2 row">
                                                ...
                                                <div class="pr-2 pl-0 col-4 text-center">
                                                    <input type="text" name="Vertical_Lc" id="Vertical_Lc" class="form-control" value="<?=$informe["Vertical_Lc"]; ?>">
                                                </div>
                                                <div class="pr-2 pl-0 col-4 text-center">
                                                    <input type="text" name="Vertical_Loc" id="Vertical_Loc" class="form-control" value="<?=$informe["Vertical_Loc"]; ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="align-items-center pt-2 row">
                                                ...
                                                <div class="pr-2 pl-0 col-4 text-center">
                                                    <input type="text" name="Horizontal_Lc" id="Horizontal_Lc" class="form-control" value="<?=$informe["Horizontal_Lc"]; ?>">
                                                </div>
                                                <div class="pr-2 pl-0 col-4 text-center">
                                                    <input type="text" name="Horizontal_Loc" id="Horizontal_Loc" class="form-control" value="<?=$informe["Horizontal_Loc"]; ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-body">
                                                    <div class="container-fluid">
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <textarea name="Observaciones_Analisis_Vib" id="Observaciones_Analisis_Vib" rows="5" class="form-control"><?=$informe["Observaciones_Analisis_Vib"]; ?></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-6">
                                            <div class="row">
                                                <div class="text-center col-12">
                                                    ...
                                                    <input type="text" name="Ten_De_Pruebas" id="Ten_De_Pruebas" class="form-control" value="<?=$informe["Ten_De_Pruebas"]; ?>">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="pt-4 row">
                                        ...
                                        <div class="col-4">
                                            <div class="row">
                                                ...
                                                <div class="p-0 col-7">
                                                    <input type="text" name="Corriente_F1" id="Corriente_F1" class="form-control" value="<?=$informe["Corriente_F1"]; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-4">
                                            <div class="row">
                                                ...
                                                <div class="p-0 col-7">
                                                    <input type="text" name="Corriente_F2" id="Corriente_F2" class="form-control" value="<?=$informe["Corriente_F2"]; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-4">
                                            <div class="row">
                                                ...
                                                <div class="p-0 col-7">
                                                    <input type="text" name="Corriente_F3" id="Corriente_F3" class="form-control" value="<?=$informe["Corriente_F3"]; ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-body">
                                                    <div class="container-fluid">
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <textarea name="Observaciones_Pru_Sin_Carga" id="Observaciones_Pru_Sin_Carga" rows="5" class="form-control"><?=$informe["Observaciones_Pru_Sin_Carga"]; ?></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                ...
                <div class="pt-3 row">
                    <div class="col-6">
                        <div class="row">
                            ...
                            <div class="col-9">
                                <select class="form-control select2" id="Cedula_Responsable" name="Cedula_Responsable" required>
                                        <option value="">Seleccione ...</option>
