    ...
    <table class="table-borderless" style="padding-top: 15px;" width="100%;">
    ...
    <table class="table-borderless" width="100%;">
        <tbody>
            <tr>
                <td style="padding-left: 240px;">RESULTADOS</td>
                <td style="padding-left: 280px;">REALIZADA</td>
            </tr>
        </tbody>
    </table>
    ...
    <table class="table-borderless" style="padding-top: 15px;" width="100%;">
        ...
        <thead>
            ...
            <tr>
                <td style="font-weight: bold; padding-left: 580px;">(Vel/Pulg/Seg)</td>
            </tr>
        </thead>
    ...
    <table class="table-borderless" width="100%;">
        <tbody>
            <tr>
                <td style="padding-left: 570px;">L.C</td>
    ...
    <table class="table table-borderless" style="padding-left: 250px;">
        <tr>
            <td>
                <span style="font-weight: bold;">ING. DE PLANTA: </span>
                <td class="pt-4" style="width: 62%;">
                    <hr>
    ...
    $canvas->page_text(500, 20, "Pag: {PAGE_NUM}", $font, 11, array(0,0,0));
    $canvas->page_text(30, 20, 'Fecha: ' . fechaCastellano($fechaImpresion), $font, 11, array(0,0,0));
