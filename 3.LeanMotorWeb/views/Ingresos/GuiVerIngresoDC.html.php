...
<div class="card">
	<div class="card-header">
		<h4>
			<b>Ingreso Equipo DC - Consultando</b>
		</h4>
	</div>
					...
					<div class="col-3">
						<div class="row">
							<div class="p-0 col-2">
								...
								<input class="form-control" name="Tapa_Caja_Conexiones" id="Tapa_Caja_Conexiones" type="checkbox" style="width: 20px; margin: -5px 20px;" disabled checked>
								<?php else: ?>
								<input class="form-control" name="Tapa_Caja_Conexiones" id="Tapa_Caja_Conexiones" type="checkbox" style="width: 20px; margin: -5px 20px;" disabled>
								<?php endif; ?>
							</div>
							<div class="col-10">
					...
					<div class="col-3">
						<div class="row">
							<div class="p-0 col-2">
								...
								<input class="form-control" name="Armadura" id="Armadura" type="checkbox" style="width: 20px; margin: -5px 20px;" disabled checked>
								<?php else: ?>
								<input class="form-control" name="Armadura" id="Armadura" type="checkbox" style="width: 20px; margin: -5px 20px;" disabled>
								<?php endif; ?>
							</div>
							<div class="col-10">
				...
				<div class="border-top pt-3 pb-3 row">
					...
					<div class="col-3">
						<div class="row">
							...
							<div class="col-4">
                            	<input type="number" name="textvisor" id="textvisor" class="form-control" style="display: none;" value="<?=$Ingreso["Visor"];?>" readonly>
							</div>
						</div>
					</div>
				</div>
