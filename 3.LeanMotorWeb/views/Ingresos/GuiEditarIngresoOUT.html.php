...
<div class="card">
	<div class="card-header">
		<h4>
			<b>Ingreso de Outsourcing - Editando</b>
		</h4>
	</div>

	<div class="card-body">
		<form method="post" autocomplete="off" action="<?=getUrl("Ingresos", "Ingresos", "postEditarOT"); ?>">
					...
					<div class="col-5">
						<div class="row">
							<div class="col-8">
		                        ...
		                        <button type="submit" class="btn btn-primary" name="RegIngreso" id="RegIngreso" value="Guardar" title="Guardar Ingreso OT"><i class="fa fa-save"></i></button> 
					...
					<div class="col-3">
						<div class="row">
							...
							<div class="col-8">
								...
								<input type="hidden" name="Numero_SerieOUT" id="Numero_SerieOUT" value="<?=$Ingreso["Numero_Serie"];?>">
							</div>
						</div>
					</div>
									...
									<table class="table table-borderless table-hover">
										...
										<?php if ($Detalle != null): ?>
											...
											<tr class="datosElectricos type-number">
												...
												<td width="13%"><input type="text" class="form-control" name="Revoluciones_Por_MinutoEditar[]" id="Revoluciones_Por_Minuto<?=$cont; ?>"value="<?=$deta["Revoluciones_Por_Minuto"]; ?>"></td>
												<td width="13%"><input type="text" class="form-control" name="VaEditar[]" id="Va<?=$cont; ?>"value="<?=$deta["Va"]; ?>"></td>
												<td width="13%"><input type="text" class="form-control" name="VcEditar[]" id="Vc<?=$cont; ?>"value="<?=$deta["Vc"]; ?>"></td>
												<td width="13%">
													<input type="text" class="form-control" name="IaEditar[]" id="Ia<?=$cont; ?>" value="<?=$deta["Ia"]; ?>">
												</td>
												<td width="13%"><input type="text" class="form-control" name="IcEditar[]" id="Ic<?=$cont; ?>" value="<?=$deta["Ic"]; ?>"></td>
												<td>
