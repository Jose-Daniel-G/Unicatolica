...
<div class="card">
	<div class="card-header">
		<h4>
			<b>Ingreso de Partes FA-06 - Editando</b>
		</h4>
	</div>

	<div class="card-body">
		<form method="post" autocomplete="off" action="<?=getUrl("Ingresos","Ingresos","postEditarPT"); ?>">
			...
			<div class="container-fluid">
				...
				<div class="border-top pt-3 pb-3 row">
					<div class="col-3">
						<div class="row">
							...
							<div class="p-0 col-8">
								...
								<input type="hidden" name="Numero_SeriePT" id="Numero_SeriePT" value="<?=$equi["Numero_Serie"];?>">
							</div>
						</div>
					</div>
					...
					<div class="col-3">
						<div class="row">
							...
							<div class="col-8">
								<input class="form-control" name="cantidad" id="cantidad" value="<?=$Ingreso["Cantidad"]; ?>">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-4">
					<div class="row">
						...
						<div class="p-0 col-9">
							<input class="form-control" name="referencia" id="referencia" value="<?=$Ingreso["Referencia"]; ?>">
						</div>
					</div>
				</div>
				...
				<div class="col-3">
					<div class="row">
						...
						<div class="p-0 col-9">
							<input class="form-control" name="tipo" id="tipo" value="<?=$Ingreso["Tipo"]; ?>">
						</div>
					</div>
				</div>
				...
				<div class="col-3">
					<div class="row">
						...
						<div class="p-0 col-8">
							<input class="form-control" name="modelo" id="modelo" value="<?=$Ingreso["Modelo"]; ?>">
						</div>
					</div>
				</div>
			...
			<div class="border-top pt-3 pb-3 row">
				...
				<div class="col-5">
					<div class="row">
						...
						<div class="p-0 col-9">
							<input class="form-control" name="dimensiones" id="dimensiones" value="<?=$Ingreso["Dimensiones"]; ?>">
						</div>
					</div>
				</div>
				...
				<div class="col-2">
					<div class="row">
						...
						<div class="p-0 col-7">
							<input class="form-control" name="voltaje" id="voltaje" value="<?=$Dequi["Voltaje"]; ?>">
						</div>
					</div>
				</div>
				...
				<div class="col-2">
					<div class="row">
						...
						<div class="p-0 col-6">
							<input class="form-control" name="amperaje" id="amperaje" value="<?=$Dequi["Amperaje"]; ?>">
						</div>
					</div>
				</div>
				...
				<div class="col-3">
					<div class="row">
						...
						<div class="p-0 col-5">
							<input class="form-control" name="velocidad" id="velocidad" value="<?=$Ingreso["Velocidad_Parte"]; ?>">
						</div>
						<div class="col-3">
							<label>Rpm</label>
						</div>
					...
					<div class="pt-2 col-2">
						<div class="row">
							<div class="p-0 col-2">
								...
								<input class="form-control" style="width: 20px; margin: -5px 20px;" name="Enviado_Para" id="Otros" type="radio" required checked>
								<?php else: ?>
								<input class="form-control" style="width: 20px; margin: -5px 20px;" name="Enviado_Para" id="Otros" type="radio" value=" requiredOtros">
								<?php endif; ?>
							</div>
							<div class="col-10">
