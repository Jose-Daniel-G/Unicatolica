...
<div class="card">
	<div class="card-header">
		<h4>
			<b>Ingreso Equipo AC - Editando</b>
		</h4>
	</div>

	<div class="card-body">
		<form method="post" autocomplete="off" action="<?=getUrl("Ingresos", "Ingresos", "postEditarAC"); ?>">
			<?php 
					...
					<div class="col-5">
						...
						<div class="row">
							<div class="col-8">
								...
								<button type="submit" class="btn btn-primary" name="RegIngresoAV" id="RegIngresoAV" value="Guardar"><i class="fa fa-save"></i></button>
								...
								<button type="button" class="btn text-white" style="background-color: Red;" name="AnularIngreso" title="Anular Ingreso"  data-url='<?=getUrl("Ingresos", "Ingresos", "AnularIngreso", false, "ajax")  ?>' id="AnularIngreso" style='cursor:pointer;' value="Anular"><i class="fa fa-trash-alt"></i></button>
				...
				<div class="border-top pt-3 pb-3 row">
					<div class="col-2">
						<div class="row">
							...
							<div class="p-0 col-5">
								<input class="form-control" name="fases" id="fases" value="<?=$equi["No_Fases"];?>">
							</div>
						</div>
					</div>
					...
					<div class="pt-2 col-2">
						<div class="row">
							<div class="p-0 col-2">
								...
								<?php else: ?>
								<input class="form-control" style="width: 20px; margin: -5px 20px;" name="Enviado_Para" id="Reparacion" type="radio" value="Reparacion">
								<?php endif; ?>
							</div>
							<div class="col-10">
					...
					<div class="pt-2 col-2">
						<div class="row">
							<div class="p-0 col-2">
								...
								<?php else: ?>
								<input class="form-control" style="width: 20px; margin: -5px 20px;" name="Enviado_Para" id="Mantenimiento" type="radio" value="Mantenimiento">
								<?php endif; ?>
							</div>
							<div class="col-10">
					...
					<div class="pt-2 col-2">
						<div class="row">
							<div class="p-0 col-2">
								...
								<?php else: ?>
								<input class="form-control" style="width: 20px; margin: -5px 20px;" name="Enviado_Para" id="Garantia" type="radio" value="Garantia">
								<?php endif; ?>
							</div>
							<div class="col-10">
					...
					<div class="pt-2 col-2">
						<div class="row">
							<div class="p-0 col-2">
								...
								<?php else: ?>
								<input class="form-control" style="width: 20px; margin: -5px 20px;" name="Enviado_Para" id="Outsourcing" type="radio" value="Outsourcing">
								<?php endif; ?>
							</div>
							<div class="col-10">
					...
					<div class="pt-2 col-2">
						<div class="row">
							<div class="p-0 col-2">
								...
								<?php else: ?>
								<input class="form-control" style="width: 20px; margin: -5px 20px;" name="Enviado_Para" id="otros" type="radio" value="Otros">
								<?php endif; ?>
							</div>
							<div class="col-10">
					...
					<div class="col-3">
						<div class="row">
							<div class="p-0 col-2">
								...
								<input class="form-control" name="Inventario_Rotor" id="Inventario_Rotor" type="checkbox" style="width: 20px; margin: -5px 20px;" checked>
								<?php else: ?>
					...
					<div class="col-3">
						<div class="row">
							<div class="p-0 col-2">
								...
								<input class="form-control" name="Tapa_Conexiones" id="Tapa_Conexiones" type="checkbox" style="width: 20px; margin: -5px 20px;" checked>
								<?php else: ?>
					...
					<div class="col-3">
						<div class="row">
							<div class="p-0 col-2">
								...
								<input class="form-control" name="Flanje" id="Flanje" type="checkbox" style="width: 20px; margin: -5px 20px;" checked>
								<?php else: ?>
											...
											<tr class="datosElectricos type-number">
												...
												<td width="20%">
													<select class="form-control select2" id="Unidad_De_Potencia<?=$cont; ?>" name="Unidad_De_PotenciaEditar[]">
														<?php
														$options = array(
															"valor" => "Seleccione ...", "HP", "KW", "W", "KVA", "MVA", "VA", "CV"
														);
														?>
												...
												<td width="20%">
													<input type="text" class="form-control" name="VoltajeEditar[]" id="Voltaje<?=$cont; ?>" value="<?=$deta["Voltaje"]; ?>">
												</td>
												<td width="20%">
													<input type="text" class="form-control" name="AmperajeEditar[]" id="Amperaje<?=$cont; ?>" value="<?=$deta["Amperaje"]; ?>">
												</td>
												<td>
									...
									<div class="container">
										...
										<div class="row">
											<div class=" col-sm-4">
												...
												<input class="form-control" name="Cos" id="Cos" value="<?=$deta2["Cos"]; ?>">
											</div>

											<div class=" col-sm-4">
												<label>Eficiencia %</label>
												<input class="form-control" name="Eficiencia" id="Eficiencia" value="<?=$deta2["Eficiencia"]; ?>">
											</div>
												...
												<div class="row">
													...
													<div class="col-sm-4">
														...
														<select class="form-control" id="RotorDetalle" name="RotorDetalle">
															<?php 
															$options = array(
																"valor" => "Seleccione ...", "Jaula de Ardilla", "Devanado",
															);
															?>
															<?php foreach ($options as $valor): ?>
