...
<div class="card">
	<div class="card-header">
		<h4>
			<b>Conexiones, Placa y Frame - Editando</b>
		</h4>
	</div>
						...
						<div class="row">
							...
							<div class="col-6">
								<div class="row">
									...
									<div class="col-11">
										<input type="number" name="B" id="B" class="form-control" value="<?=$diagnostico["B"]; ?>">
									</div>
								</div>
							</div>
							...
							<div class="col-6">
								<div class="row">
									...
									<div class="col-11">
										<input type="number" name="C" id="C" class="form-control" value="<?=$diagnostico["C"]; ?>">
									</div>
								</div>
							</div>
						...
						<div class="pt-3 row">
							...
							<div class="col-6">
								<div class="row">
									...
									<div class="col-11">
										<input type="number" name="E" id="E" class="form-control" value="<?=$diagnostico["E"]; ?>">
									</div>
								</div>
							</div>
							...
							<div class="col-6">
								<div class="row">
									...
									<div class="col-11">
										<input type="number" name="A" id="A" class="form-control" value="<?=$diagnostico["A"]; ?>">
									</div>
								</div>
							</div>
						...
						<div class="pt-3 row">
							...
							<div class="col-6">
								<div class="row">
									...
									<div class="col-11">
										<input type="number" name="AB" id="AB" class="form-control" value="<?=$diagnostico["AB"]; ?>">
									</div>
								</div>
							</div>
							...
							<div class="col-6">
								<div class="row">
									...
									<div class="col-11">
										<input type="number" name="H" id="H" class="form-control" value="<?=$diagnostico["H"]; ?>">
									</div>
								</div>
							</div>
						...
						<div class="pt-3 row">
							...
							<div class="col-6">
								<div class="row">
									...
									<div class="col-11">
										<input type="number" name="HD" id="HD" class="form-control" value="<?=$diagnostico["HD"]; ?>">
									</div>
								</div>
							</div>
							...
							<div class="col-3">
								<div class="justify-content-center row">
									<div class="col-4">
										...
										<input class="form-control tiene" name="Cancamo_Tiene" id="Cancamo_Tiene" type="radio" style="width: 20px; margin: -5px 20px;" checked>
										<?php else: ?>
							...
							<div class="col-3 offset-1">
								<div class="row">
									<div class="col-4">
										...
										<input class="form-control tiene" name="Cancamo_Bueno" id="Cancamo_Bueno" type="radio" style="width: 20px; margin: -5px 20px;" checked>
										<?php else: ?>
										...
										<div class="row">
											<div class="col-3">
												<div class="row">
													<div class="col-4">
														...
														<input class="form-control Cancamo_Suministrar_Reparar" name="Cancamo_Suministrar" id="Cancamo_Suministrar" type="radio" style="width: 20px; margin: -5px 20px;" checked>
														<?php else: ?>
														<input class="form-control Cancamo_Suministrar_Reparar" name="Cancamo_Suministrar" id="Cancamo_Suministrar" type="radio" style="width: 20px; margin: -5px 20px;">
														<?php endif; ?>
													</div>
													<div class="col-6">
											...
											<div class="col-6">
												<div class="row" id="inputReferenciaCancamo" style="display: none;">
													...
													<div class="p-0 col-8">
														<input type="text" name="Cancamo_Referencia" id="Cancamo_Referencia" class="form-control" value="<?=$diagnostico["Cancamo_Referencia"]; ?>">
													</div>
												</div>
											</div>
										</div>
							...
							<div class="col-12 offset-2">
								<div class="row">
									<div class="col-1">
										...
										<input class="form-control Cancamo_Suministrar_Reparar" name="Cancamo_Reparar" id="Cancamo_Reparar" type="radio" style="width: 20px; margin: -5px 20px;" checked>
										<?php else: ?>
										<input class="form-control Cancamo_Suministrar_Reparar" name="Cancamo_Reparar" id="Cancamo_Reparar" type="radio" style="width: 20px; margin: -5px 20px;">
										<?php endif; ?>
									</div>
									<div class="col-8">
							...
							<div class="col-3">
								<div class="justify-content-center row">
									<div class="col-4">
										...
										<input class="form-control" name="Placa_Tiene" id="Placa_Tiene" type="radio" style="width: 20px; margin: -5px 20px;" checked>
										<?php else: ?>
							...
							<div class="col-3 offset-1">
								<div class="row">
									<div class="col-4">
										...
										<input class="form-control" name="Placa_Bueno" id="Placa_Bueno" type="radio" style="width: 20px; margin: -5px 20px;" checked>
										<?php else: ?>
										...
										<div class="row">
											<div class="col-3">
												<div class="row">
													<div class="col-4">
														...
														<input class="form-control Placa_Suministrar_Reparar" name="Placa_Suministrar" id="Placa_Suministrar" type="radio" style="width: 20px; margin: -5px 20px;" checked>
														<?php else: ?>
														<input class="form-control Placa_Suministrar_Reparar" name="Placa_Suministrar" id="Placa_Suministrar" type="radio" style="width: 20px; margin: -5px 20px;">
														<?php endif; ?>
													</div>
													<div class="col-6">
											...
											<div class="col-6">
												<div class="row" id="inputReferenciaPlaca" style="display: none;">
													...
													<div class="p-0 col-8">
														<input type="text" name="Placa_Referencia" id="Placa_Referencia" class="form-control" value="<?=$diagnostico["Placa_Referencia"]; ?>">
													</div>
												</div>
											</div>
										</div>
							...
							<div class="col-12 offset-2">
								<div class="row">
									<div class="col-1">
										...
										<input class="form-control Placa_Suministrar_Reparar" name="Placa_Reparar" id="Placa_Reparar" type="radio" style="width: 20px; margin: -5px 20px;" checked>
										<?php else: ?>
										<input class="form-control Placa_Suministrar_Reparar" name="Placa_Reparar" id="Placa_Reparar" type="radio" style="width: 20px; margin: -5px 20px;">
										<?php endif; ?>
									</div>
									<div class="col-8">
...
$(document).ready(function () {
	...
	if($("#Cancamo_Tiene").is(":checked")){
		$("#Cancamo_Tiene").trigger("click");
	}
	if(!$("#Cancamo_Bueno").is(":checked")){
		$("#Cancamo_Malo").trigger("click");
	}

	$("#opcionesSumistrarRepararCancamo").find("input").each(function () {
		if ($(this).attr("id") == "Cancamo_Suministrar") {
			if ($(this).attr("checked")) {
				$("#Cancamo_Suministrar").trigger("click");
			}
		} else if ($(this).attr("id") == "Cancamo_Reparar") {
			if ($(this).attr("checked")) {
				$("#Cancamo_Reparar").trigger("click");
			}
		}
	});
	...
	if($("#Placa_Tiene").is(":checked")){
		$("#Placa_Tiene").trigger("click");
	}
	if(!$("#Placa_Bueno").is(":checked")){
		$("#Placa_Malo").trigger("click");
	}

	$("#opcionesSumistrarRepararPlaca").find("input").each(function () {
		if ($(this).attr("id") == "Placa_Suministrar") {
			if ($(this).attr("checked")) {
				$("#Placa_Suministrar").trigger("click");
			}
		} else if ($(this).attr("id") == "Placa_Reparar") {
			if ($(this).attr("checked")) {
				$("#Placa_Reparar").trigger("click");
			}
		}
	});
});
